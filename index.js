...
app.use('/covid/css', express.static(path.join(__dirname, 'HooHacks20','Website','css')))
app.use('/covid/js', express.static(path.join(__dirname, 'HooHacks20','Website','js')))
...
app.get('/covid', function(req,res){
    ...
    res.render(path.join(__dirname,'HooHacks20','Website','index.hbs')); 
});
